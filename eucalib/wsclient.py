...
class EucaISConnection(object):
    ...
    def get_import_task(self, worker_id):
        params = {'InstanceId': worker_id}
    ...
    def put_import_task_status(self, worker_id=None, task_id=None, status=None, volume_id=None, bytes_converted=None, error_code=None):
        if task_id is None or status is None:
            raise RuntimeError("Invalid parameters")
        params = {'InstanceId': worker_id, 'ImportTaskId': task_id, 'Status': status}
